...
(function() {
    ...
    $(document).ready(function() {
        $('.django-select2:not([name*="__prefix__"]):not([name*="__phone_update_prefix__"]):not([name*="__contact_update_prefix__"])').each(function() {
            DjangoSelect2.init(this);
        });
        $(document).on('formset:added', function(event, $form) {
            $form.find('.django-select2:not([name*="__prefix__"]):not([name*="__phone_update_prefix__"]):not([name*="__contact_update_prefix__"])').each(function() {
                DjangoSelect2.init(this);
            });
        });
    });
